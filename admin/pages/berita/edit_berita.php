...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="index.php?action=berita_update&id=<?= $berita['id'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <!-- Judul -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control <?= isset($errors['isi_singkat']) ? 'is-invalid' : '' ?>" 
                                          ...
                                          rows="3" required><?= htmlspecialchars($data['isi_singkat']) ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control <?= isset($errors['isi_lengkap']) ? 'is-invalid' : '' ?>" 
                                          ...
                                          required><?= $data['isi_lengkap'] ?></textarea>
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <img src="<?= htmlspecialchars($berita['gambar']) ?>" 
                                             ...
                                             onerror="this.src='https://placehold.co/400x300/png?text=No+Image'">
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Format: JPG, PNG, GIF, WEBP (Max 5MB). Kosongkan jika tidak ingin mengubah.</small>
