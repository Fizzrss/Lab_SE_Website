...
// Merge old input with berita data
$data = array_merge($berita, $oldInput);
?>
...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Berita</h3>
                <p class="text-subtitle text-muted">Ubah informasi berita</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formEditBerita" action="index.php?action=berita_update&id=<?= $berita['id'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control <?= isset($errors['isi_singkat']) ? 'is-invalid' : '' ?>" 
                                          ...
                                          required><?= htmlspecialchars($data['isi_singkat']) ?></textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea id="summernote" name="isi_lengkap" class="form-control <?= isset($errors['isi_lengkap']) ? 'is-invalid' : '' ?>"><?= $data['isi_lengkap'] ?></textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control <?= isset($errors['tanggal_publikasi']) ? 'is-invalid' : '' ?>" 
                                       ...
                                       value="<?= htmlspecialchars($data['tanggal_publikasi']) ?>" 
                                       required>
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-body p-2">
                                            <img src="<?= htmlspecialchars($berita['gambar']) ?>" 
                                                 ...
                                                 onerror="this.src='assets/compiled/jpg/2.jpg'">
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 d-flex justify-content-end">
                            <a href="index.php?action=berita_list" class="btn btn-light-secondary me-2">Batal</a>
...
<script>
    $(document).ready(function() {
        ...
        $('#formEditBerita').on('submit', function(e) {
            ...
            var isiBerita = $('#summernote').summernote('code');
            ...
            if ($('#summernote').summernote('isEmpty')) {
                Swal.fire('Peringatan', 'Isi berita tidak boleh kosong!', 'warning');
                return;
            }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $('textarea[name="isi_lengkap"]').val(isiBerita);
                    form.submit(); 
                }
            });
        });
