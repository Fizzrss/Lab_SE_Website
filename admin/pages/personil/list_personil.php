    ...
    <section class="section">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title m-0">Data Personil</h5>
                <a href="index.php?action=personil_add" class="btn btn-primary btn-sm">
                    <i class="bi bi-plus-lg"></i> Tambah Personil
                </a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <?php if (!empty($row['gscholar'])): ?>
                                                <a href="<?= $row['gscholar'] ?>" target="_blank" class="btn btn-sm btn-outline-info" title="Google Scholar">
                                                    <i class="bi bi-google"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if (!empty($row['linkedin'])): ?>
                                                <a href="<?= $row['linkedin'] ?>" target="_blank" class="btn btn-sm btn-outline-primary" title="LinkedIn">
                                                    <i class="bi bi-linkedin"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if (empty($row['gscholar']) && empty($row['linkedin'])) echo '<span class="text-muted">-</span>'; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-2">
